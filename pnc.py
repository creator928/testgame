...
#인형 리스트(인형 이름, 체력, 연산력, 방어력, 치명률, 치명피해, 회피율, 스킬 쿨타임)
wr01_Sol     = PlayerDoll("솔"      , _hp=500, _mp=200, _atk=65, _dfs=10, _crt=20, _crd=50, _avd=5, _cool=3)
gd01_Croque  = PlayerDoll("크로크"  , _hp=600, _mp=300, _atk=40, _dfs=25, _crt=15, _crd=30, _avd=10, _cool=3)
sn01_Clukay  = PlayerDoll("클루카이", _hp=400, _mp=300, _atk=55, _dfs=5, _crt=30, _crd=100, _avd=0, _cool=3)
sp01_Luna    = PlayerDoll("보름"    , _hp=500, _mp=400, _atk=50, _dfs=10, _crt=30, _crd=70, _avd=20, _cool=3)
md01_Persica = PlayerDoll("페르시카", _hp=400, _mp=400, _atk=35, _dfs=15, _crt=10, _crd=20, _avd=10, _cool=3)
